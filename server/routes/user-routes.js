...
router.get("/users/:username", (req, res) => {
  ...
  const params = {
    TableName: table,
    KeyConditionExpression: "#un = :user", // specifies the search criteria (think SQL WHERE clause)
    ExpressionAttributeNames: {
      // #un is an abbreviation that represents username (think SQL AS statement)
